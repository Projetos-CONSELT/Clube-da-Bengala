          ...
          <TabsContent value="usuarios" className="mt-4 space-y-4">
            ...
            {usuariosQuery.isLoading ? (
              ...
              (() => {
                ...
                const roleSections = [
                  { key: 'ceo', label: 'CEOs / Administradores Globais', color: 'border-purple-200 bg-purple-50/50 text-purple-900', badge: 'bg-purple-100 text-purple-800' },
                ...
                const renderUserItem = (u: any) => {
                  const isSelectDisabled = currentUserRole !== 'gerente' && currentUserRole !== 'ceo';

                  const getAllowedRoles = () => {
                    if (currentUserRole === 'gerente' || currentUserRole === 'ceo') {
